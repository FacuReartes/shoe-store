  ...
  return (
    <div>
      ...
      <div className='flex flex-col items-center w-full gap-3 md:flex-row md:px-4'>
        <div className='relative z-10 bg-[url(./img/shoe-new2.jpg)] w-11/12 h-[400px] bg-cover bg-center lg:h-[600px]'>
        ...
        <div className='relative z-10 bg-[url(./img/shoe-new1.jpg)] w-11/12 h-[400px] bg-cover bg-center lg:h-[600px]'>
          <div className='absolute bottom-0 px-5 py-3 flex justify-center flex-col gap-1'>
